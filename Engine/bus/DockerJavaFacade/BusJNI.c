...
#include "com_urv_zion_bus_BusJNI.h"
#include "bus.h"
...
int init_java_accessors( JNIEnv* env )
{
     ...
     * */
	g_ClassRawMessage =
			(*env)->FindClass( env, "com/urv/zion/bus/BusRawMessage" );
...
Java_com_urv_zion_bus_BusJNI_startLogger( 	JNIEnv* env,
												jobject obj,
												jstring jLevel,
												jstring jContId )
{
 ...
 * */
JNIEXPORT void JNICALL
Java_com_urv_zion_bus_BusJNI_stopLogger( 	JNIEnv* env,
												jobject obj )
{
	bus_stop_logger();
}
...
Java_com_urv_zion_bus_BusJNI_createBus( 	JNIEnv* env,
												jobject obj,
												jstring jstrPath )
{
	int nBus = -1;
 ...
 * */
JNIEXPORT jint JNICALL
Java_com_urv_zion_bus_BusJNI_listenBus( 	JNIEnv* env,
												jobject obj,
												jint    jnBus )
{
 ...
 * */
JNIEXPORT jint JNICALL
Java_com_urv_zion_bus_BusJNI_sendRawMessage( 	JNIEnv* env,
													jobject obj,
													jstring jstrPath,
													jobject jMsg )
{
...
Java_com_urv_zion_bus_BusJNI_receiveRawMessage( 	JNIEnv* env,
														jobject obj,
														jint    jnBus )
{
